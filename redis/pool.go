...
var (
	errPoolClosed = errors.New("RedisGo-Async: connection pool closed")
	errConnClosed = errors.New("RedisGo-Async: connection closed")
)
...
func (p *Pool) get() (Conn, error) {
	...
	for {
		...
		if p.closed {
			p.mu.Unlock()
			return nil, errors.New("RedisGo-Async: get on closed pool")
		}
